      ...
      <main className="pb-24">
        <section className="border-b border-[#ececf0] bg-[linear-gradient(180deg,#fff_0%,#fff5f6_100%)]">
          <div className="mx-auto max-w-6xl px-6 py-16">
            <p className="mb-3 text-xs font-semibold uppercase tracking-[0.14em] text-[#ef3333]">Base juridica do site</p>
            ...
            <p className="mt-4 text-sm font-medium text-[#8a8a92]">Ultima atualizacao: {LEGAL_LAST_UPDATED}</p>
          </div>
        </section>

    ...
    >
      <div className="space-y-2">
        ...
        <p className="text-sm leading-relaxed text-[#4f4f57]">
          A {BRAND.name} usa cookies e armazenamento local para autenticação, segurança, preferências do usuário
          e registro do consentimento. Recursos opcionais só devem ser ativados mediante sua autorização.
        </p>
